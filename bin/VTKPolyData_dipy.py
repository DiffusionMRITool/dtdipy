...
Options:
  ...
  --vtk f1...              Input VTK PolyData (.vtk, .vtp, etc), multiple inputs (file1,file2,...). Use HueRange=(0.6667,0).
  --vtk2 f1...             Input VTK Polydata, multiple inputs. Use HueRange=(0,1). Specified for meshes from tensors colored by directions, generated by MeshFromTensors.
