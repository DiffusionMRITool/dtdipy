...
Usage:
  VTKPolyData_dipy.py [--vtk f1,f2] [--vtk2 f1,f2] [--image <nifti_file>] [--track f1,f2] [--image_axes x,y,z] [--size s1,s2] [--world_coords] [--frame] [--scalar_range r1,r2] [--png pngfile] [--zoom zoom] [--bgcolor r,g,b] [-v] [--no-normal] [--ni] [--so opa]
